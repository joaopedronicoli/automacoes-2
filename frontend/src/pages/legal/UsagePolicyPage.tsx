        ...
        <div className="max-w-3xl mx-auto py-4">
            ...
            <div className="glass-card rounded-xl p-6 md:p-8 space-y-6 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                {isPt ? (
                    <>
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">1. Termos Gerais</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">2. Uso Aceitável</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">3. Contas e Acesso</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">4. Automações e Integrações</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">7. Suspensão e Encerramento</h2>
                    ...
                    <>
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">1. General Terms</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">4. Automations and Integrations</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">6. Plans and Payments</h2>
                        ...
                        <section>
                            <h2 className="text-lg font-semibold text-foreground mb-3">7. Suspension and Termination</h2>
